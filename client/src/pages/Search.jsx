            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                ...
                <div className='flex gap-2 flex-wrap items-center'>
                 ...
                 <div className='flex items-center gap-2'>
                    ...
                    <select onChange={handleChange} defaultValue={'created_at_desc'} id="sort_order" className='border p-3 rounded-lg'>
                 ...
                 <button className='bg-green-500 text-white p-3 rounded-lg uppercase hover:opacity-95'>Search</button>
            </form>
        </div>
        <div className='flex-1'>
            ...
            <div className='p-7 flex flex-wrap gap-4'>
                {!loading && listings.length === 0 && (
                    <p className='text-xl text-red-500 text-center w-full '>No listings found</p>
                )}
                {loading &&(
